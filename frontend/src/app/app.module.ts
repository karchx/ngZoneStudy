...
import {
	NbActionsModule, NbButtonModule, NbCardModule, NbDialogModule, NbIconModule, NbInputModule, NbLayoutModule, NbListModule, NbMenuModule, NbSidebarModule, NbSidebarService, NbThemeModule
} from '@nebular/theme';
...
@NgModule({
	...
	imports: [
		...
		NbMenuModule,
		NbInputModule,
		StoreModule.forRoot({ themes: themeReducer }),
